#!/bin/sh
set -e
#  Code adapted by one generated by godownloader. Do not edit.
#

usage() {
  this=$1
  cat <<EOF
$this: download go binaries for databricks/eng-dev-ecosystem

Usage: $this [-b] bindir [version]
  -b sets bindir or installation directory, default "/usr/local/bin"
   [version] is a version number from
   https://github.com/databricks/eng-dev-ecosystem/releases
