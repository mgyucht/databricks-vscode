...
provider "databricks" {
  ...
  azure_client_secret = local.can_of_worms["deco-github-azure-prod:ARM-CLIENT-SECRET"]
  azure_tenant_id     = local.can_of_worms["deco-github-azure-prod:ARM-TENANT-ID"]
}
